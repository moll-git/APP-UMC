...
return [
    ...
    'groups_tab'                 => 'Grups',
    'concerts_works'             => ':count obra|:count obres',
    'concerts_repertoire_label'  => 'REPERTORI',
    'concerts_youtube'           => 'Veure a YouTube',
    'concerts_no_records'        => 'No hi ha concerts registrats',
    'concerts_new'               => 'Nou concert',
    'concerts_modal_new_title'   => 'Nou Concert',
    'concerts_modal_edit_title'  => 'Editar Concert',
    'concerts_confirm_delete'    => 'Segur que vols eliminar aquest concert?',
    'concerts_repertoire_pending'=> 'Repertori pendent de confirmar',
    'concerts_add_works'         => '+ Afegir obres',
    'concerts_setup_label'       => 'MUNTATGE',
    'concerts_no_groups_assigned'=> 'Cap grup assignat',
    'concerts_select_to_view'    => 'Selecciona un concert per veure els detalls',
    ...
    // WORK GROUPS
    'organization_label'       => 'ORGANITZACIÓ',
    'work_groups_title'        => 'Grups de treball',
    'work_groups_description'  => "La banda compta amb :count grups de treball encarregats de muntar i desmontar l'escenari als concerts. Fes clic en un grup per veure'n els participants.",
    'no_description'           => 'Sense descripció',
    'group_participants_count' => ':count participant|:count participants',
    'group_members_of'         => 'Membres de :name',
    'group_musicians_count'    => ':count músics',
    'group_no_participants'    => 'No hi ha cap participant assignat a aquest grup.',
    'group_select_to_view'     => 'Selecciona un grup de treball per veure qui el forma',
    'role_musician'            => 'Músic',
    'delete'                   => 'Eliminar',
    'edit'                     => 'Editar',

    // CONCERT FORM
    'concert_form_title'                    => 'Títol *',
    'concert_form_title_placeholder'        => "Ex: Concert festes 6 d'agost",
    'concert_form_status'                   => 'Estat *',
    'concert_form_date'                     => 'Data *',
    'concert_form_time'                     => 'Hora',
    'concert_form_location'                 => 'Lloc',
    'concert_form_location_placeholder'     => 'Plaça Major...',
    'concert_form_vestuario'                => 'Vestuari',
    'concert_form_vestuario_placeholder'    => "Uniforme d'estiu...",
    'concert_form_notes'                    => 'Notes (opcional)',
    'concert_form_notes_placeholder'        => 'Observacions, instruccions especials...',
    'concert_form_groups'                   => 'Grups de treball (muntatge)',
    'concert_form_work_title_placeholder'   => "Nom de l'obra...",
    'concert_form_new_work_title_placeholder' => "Títol de l'obra...",
    'concert_form_youtube_placeholder'      => 'Enllaç YouTube (opcional)',
    'concert_form_create'                   => 'Crear concert',
